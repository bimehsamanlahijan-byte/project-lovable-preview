...
//#region node_modules/.nitro/vite/services/ssr/assets/client-Ce41MEoO.js
...
function readPublicEnv() {
	if (typeof window !== "undefined" && window.__PUBLIC_ENV__) return window.__PUBLIC_ENV__;
	const env = globalThis.process?.env ?? {};
	return {
		SUPABASE_URL: env["EXTERNAL_SUPABASE_URL"] || env["SUPABASE_URL"] || env["VITE_SUPABASE_URL"] || env["APP_SUPABASE_URL"] || env["APP_DB_URL"],
		SUPABASE_PUBLISHABLE_KEY: env["EXTERNAL_SUPABASE_PUBLISHABLE_KEY"] || env["SUPABASE_PUBLISHABLE_KEY"] || env["VITE_SUPABASE_PUBLISHABLE_KEY"] || env["APP_SUPABASE_PUBLISHABLE_KEY"] || env["APP_DB_PUBLISHABLE_KEY"]
	};
}
function publicEnvScript() {
	return `window.__PUBLIC_ENV__=${JSON.stringify(readPublicEnv() ?? {}).replace(/</g, "\\u003c")};`;
}
...
function createSupabaseClient() {
	...
	const SUPABASE_URL = {
		...
		"VITE_SUPABASE_URL": ""
	}["VITE_SUPABASE_URL"] || process.env["SUPABASE_URL"] || publicEnv.SUPABASE_URL;
	const SUPABASE_PUBLISHABLE_KEY = {
		...
		"VITE_SUPABASE_PUBLISHABLE_KEY": "",
		"VITE_SUPABASE_URL": ""
	}["VITE_SUPABASE_PUBLISHABLE_KEY"] || process.env["SUPABASE_PUBLISHABLE_KEY"] || publicEnv.SUPABASE_PUBLISHABLE_KEY;
...
//#endregion
export { supabase as n, publicEnvScript as t };
