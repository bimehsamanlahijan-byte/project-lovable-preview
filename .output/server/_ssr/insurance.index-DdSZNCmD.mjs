...
//#region node_modules/.nitro/vite/services/ssr/assets/insurance.index-DdSZNCmD.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: "یکی از بیمه‌های زیر را انتخاب کنید تا اطلاعات کامل، پوشش‌ها و امکان خرید آنلاین آن را مشاهده کنید."
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: items.filter((c) => c.href !== "/insurance").map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: c.href ?? "#",
