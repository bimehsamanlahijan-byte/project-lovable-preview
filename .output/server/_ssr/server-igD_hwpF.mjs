...
import { n as getResponse, r as requestHandler } from "./request-response-DrMnHfig.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-4jS7k_y1.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bs8mMwf_.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-sZ478Zpd.mjs"),
		import("./start-CUTAqRrf.mjs"),
