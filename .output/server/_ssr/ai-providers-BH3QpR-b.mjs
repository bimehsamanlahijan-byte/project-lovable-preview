...
//#region node_modules/.nitro/vite/services/ssr/assets/ai-providers-BH3QpR-b.js
var ai_providers_exports = /* @__PURE__ */ __exportAll({
...
var AI_PROVIDERS = [
		...
		models: [
			{
				...
				label: "Gemini 3.6 Flash (سریع)"
			},
			{
				value: "google/gemini-3.1-flash-lite",
				label: "Gemini 3.1 Flash Lite (کم‌هزینه)"
			},
			{
				value: "google/gemini-3.1-pro-preview",
				label: "Gemini 3.1 Pro (دقیق‌تر)"
			},
			{
				value: "openai/gpt-5.6-luna",
				label: "GPT-5.6 Luna (سریع)"
			},
			{
				value: "openai/gpt-5.5",
				label: "GPT-5.5 (قوی‌ترین)"
			}
		],
	...
	},
	{
		...
		models: [
			...
			{
				value: "deepseek/deepseek-chat-v3:free",
				label: "DeepSeek V3 (رایگان)"
			}
		],
...
//#endregion
export { ai_providers_exports as n, getProvider as r, AI_PROVIDERS as t };
