...
//#endregion
//#region node_modules/domhandler/node_modules/domelementtype/dist/index.js
...
function isTag$1(element) {
	return element.type === ElementType$2.Tag || element.type === ElementType$2.Script || element.type === ElementType$2.Style;
}
ElementType$2.Root;
ElementType$2.Text;
ElementType$2.Directive;
ElementType$2.Comment;
ElementType$2.Script;
ElementType$2.Style;
ElementType$2.Tag;
ElementType$2.CDATA;
ElementType$2.Doctype;
//#endregion
...
function isCDATA(node) {
	return node.type === ElementType$2.CDATA;
}
/**
...
function isText(node) {
	return node.type === ElementType$2.Text;
}
/**
...
function isComment(node) {
	return node.type === ElementType$2.Comment;
}
/**
...
//#endregion
//#region node_modules/dom-serializer/node_modules/domelementtype/dist/index.js
/** Types of elements found in htmlparser2's DOM */
var ElementType$1;
(function(ElementType) {
	/** Type for the root element of a document */
...
/** Type for the root element of a document */
var Root$1 = ElementType$1.Root;
/** Type for Text */
var Text$1 = ElementType$1.Text;
/** Type for <? ... ?> */
var Directive$1 = ElementType$1.Directive;
/** Type for <!-- ... --> */
var Comment$1 = ElementType$1.Comment;
/** Type for <script> tags */
var Script$1 = ElementType$1.Script;
/** Type for <style> tags */
var Style$1 = ElementType$1.Style;
/** Type for Any tag */
var Tag$1 = ElementType$1.Tag;
/** Type for <![CDATA[ ... ]]> */
var CDATA$1 = ElementType$1.CDATA;
ElementType$1.Doctype;
//#endregion
//#region node_modules/dom-serializer/node_modules/entities/dist/escape.js
/**
...
function renderNode(node, options, xmlMode) {
	switch (node.type) {
		case Root$1: return renderChildren(node.children, options, xmlMode);
		case Directive$1: return `<${node.data}>`;
		case Comment$1: return `<!--${node.data}-->`;
		case CDATA$1: return `<![CDATA[${node.children[0].data}]]>`;
		case Script$1:
		case Style$1:
		case Tag$1: return renderTag(node, options, xmlMode);
		case Text$1: {
			const element = node;
...
//#endregion
//#region node_modules/domutils/node_modules/domelementtype/dist/index.js
/** Types of elements found in htmlparser2's DOM */
var ElementType;
(function(ElementType) {
	/** Type for the root element of a document */
